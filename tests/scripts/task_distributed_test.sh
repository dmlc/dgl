...
python3 -m pytest -v --capture=tee-sys --junitxml=pytest_distributed.xml --durations=100 --ignore=tests/distributed/test_mp_dataloader.py tests/distributed/*.py || fail "distributed"

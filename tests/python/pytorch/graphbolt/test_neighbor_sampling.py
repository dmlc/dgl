...
def check_sample_basic(
    ...
    # assert torch.equal(seed_nodes, sub_graph.reverse_column_node_ids)
...
if __name__ == "__main__":
    fanouts = torch.tensor([3, 3])
    check_sample_basic(10000000, 2, False, 5, fanouts)

...
CMAKE_FLAGS="-DCUDA_TOOLKIT_ROOT_DIR=$CUDA_TOOLKIT_ROOT_DIR -DTORCH_CUDA_ARCH_LIST=7.5 -DUSE_CUDA=$USE_CUDA"

echo "Building tensoradapter for PyTorch with cmake flags: $CMAKE_FLAGS"

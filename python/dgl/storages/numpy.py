import numpy as np
from .base import FeatureStorage, ThreadFutureWrapper, register_storage_wrapper
...
class NumpyStorage(FeatureStorage):
    ...
    def fetch(self, indices, device, pin_memory=False):
        return ThreadFutureWrapper(target=self._fetch, args=(indices, device, pin_memory))

...
def preprocess_ondisk_dataset_impl(dataset_dir: str) -> str:
    """The implementation of the preprocessing function."""
...
def preprocess_ondisk_dataset(dataset_dir: str) -> str:
    ...
    with fix_dataset_dir(dataset_dir):
        return preprocess_ondisk_dataset_impl(dataset_dir)

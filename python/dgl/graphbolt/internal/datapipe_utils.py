...
CONSUMER_SLEEP_INTERVAL = (
    0.0001  # Interval between checking items availability in buffer
)
...
# Copied from:
# https://github.com/pytorch/data/blob/88c8bdc6662f37649b7ea5df0bd90a4b24a56876/torchdata/datapipes/iter/util/prefetcher.py#L34

...
def main():
    cfg = {'device': 'cpu', 'node_embed_size': -1, 'model': {'num_layers': 2, 'norm': 'both', 'hidden_size': 16, 'activation': 'relu', 'dropout': 0.5, 'use_edge_weight': False}, 'early_stop': True, 'num_epochs': 200, 'eval_period': 5, 'checkpoint_path': 'checkpoint.pt', 'patience': 20, 'optimizer': {'lr': 0.005, 'weight_decay': 0}, 'loss': 'CrossEntropyLoss'}
    device = cfg['device']

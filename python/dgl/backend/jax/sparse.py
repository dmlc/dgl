...
#     return out
#
# def _gspmm_vjp_forward(gidx, op, reduce_op, X, Y):
#     out, (argX, argY) = _gspmm(gidx, op, reduce_op, X, Y)
#     res = gidx, op, reduce_op, X, Y, argX, argY
#     return out, res
#
# def _gspmm_vjp_backward(res, dZ):
...
#     return dX, dY
#
# gspmm.defvjp(_gspmm_vjp_forward, _gspmm_vjp_backward)
#
#
...
#     return out
#
# def _gsddmm_vjp_forward(gidx, op, X, Y, lhs_target, rhs_target):
#     out = _gsddmm(gidx, op, X, Y, lhs_target, rhs_target)
#     res = gidx, op, X, Y, lhs_target, rhs_target
#     return out, res
#
# def _gsddmm_vjp_backward(res, dZ):
...
#     return dX, dY
#
# gsddmm.defvjp(_gsddmm_vjp_forward, _gsddmm_vjp_backward)
#
...
# _gsddmm_primitive = jax.core.Primitive("gsddmm")
#

# def _gspmm_implementation(gidx, op, reduce_op, X, Y):
#     out, (argX, argY) = _gspmm(gidx, op, reduce_op, X, Y)
#     return out
#
# def _gsddmm_implementation(gidx, op, X, Y, lhs_target, rhs_target):
#     out = _gsddmm(gidx, op, X, Y, lhs_target, rhs_target)
#     return out

# _gspmm_primitive.def_impl(_gspmm_implementation)
# _gsddmm_primitive.def_impl(_gsddmm_implementation)
#
# _gspmm_primitive.def_abstract_eval(_gspmm_abstract_eval)
# _gsddmm_primitive.def_abstract_eval(_gsddmm_abstract_eval)

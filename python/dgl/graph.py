...
class DGLGraph(object):
    ...
    def filter_nodes(self, predicate, nodes=ALL):
        ...
        if is_all(nodes):
            ...
            n_array = np.array(nodes)
            return F.from_numpy(n_array[np.array(n_mask, dtype='bool')])
    ...
    def filter_edges(self, predicate, edges=ALL):
        ...
        if is_all(edges):
            ...
            e_array = np.array(edges)
            return F.from_numpy(e_array[np.array(e_mask, dtype='bool')])

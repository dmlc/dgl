...
def select_topk(g, k, weight, edge_dir='in', ascending=False):
    """Select the neighbors with k-largest weights on the connecting edges for every node.
    ...
    return sample_neighbors_topk(g, nodes, k, weight, edge_dir=edge_dir, ascending=ascending)

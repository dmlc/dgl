...
- Read more about the dataset in this [blogpost](https://www.dgl.ai/news/2020/06/09/covid.html)
- DRKG is now open sourced [here](https://github.com/gnn4dr/DRKG)
- Checkout [DGL-KE](https://github.com/awslabs/dgl-ke), a tool for learning knowledge graph embedding over large-scale knowledge graph.

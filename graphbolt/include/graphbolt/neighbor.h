 ...
 * @param require_eids Boolean indicating if edge IDs are required to return.
 ...
 * their corresponding edge IDs (if required). The first tensor is of shape (3,
 * |sampled edges|), the second is of type (|sampled edges|,).
 */

 ...
 * number of samples. \note This function requires sorting the CSR or CSC matrix
 * of the graph in-place.  It prefers CSC over CSR.
 *
 * \param hg The graph.
 ...
 * the destination. \param replace Whether to sample with replacement. \param
 * redundancy How much redundant negative examples to take in case of duplicate
 * examples. \return The pair of source and destination tensors.
 */

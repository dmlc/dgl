...
# keep the list same with PyTorch's CUDA_COMMON_GPU_ARCHITECTURES
set(dgl_known_gpu_archs "35 50 52 60 61 70 75")
set(dgl_arch_ptx "75")
...
if (NOT CUDA_VERSION VERSION_LESS "11.1")
  set(dgl_known_gpu_archs "${dgl_known_gpu_archs} 86")
  set(dgl_arch_ptx "86")
endif()
...
function(dgl_select_nvcc_arch_flags out_variable)
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Manual")
    ...
    set(CUDA_ARCH_PTX ${dgl_arch_ptx} CACHE STRING "Specify 'virtual' PTX architectures to build PTX intermediate code for")
  ...
  if(${CUDA_ARCH_NAME} STREQUAL "Kepler")
    ...
    set(CUDA_ARCH_PTX "35")
  elseif(${CUDA_ARCH_NAME} STREQUAL "Maxwell")
    set(__cuda_arch_bin "50 52")
    set(CUDA_ARCH_PTX "52")
  elseif(${CUDA_ARCH_NAME} STREQUAL "Pascal")
    set(__cuda_arch_bin "60 61")
    set(CUDA_ARCH_PTX "61")
  elseif(${CUDA_ARCH_NAME} STREQUAL "Volta")
    set(__cuda_arch_bin "70")
    set(CUDA_ARCH_PTX "70")
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "All")
    ...
    set(CUDA_ARCH_PTX ${dgl_arch_ptx})
  elseif(${CUDA_ARCH_NAME} STREQUAL "Auto")
    dgl_detect_installed_gpus(__cuda_arch_bin)
    set(CUDA_ARCH_PTX ${__cuda_arch_bin})

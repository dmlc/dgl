...
def run_a_train_epoch(args, epoch, model, data_loader,
    ...
    total_scores = {metric: compute_metric(train_meter, metric) for metric in args['metrics']}
...
def run_an_eval_epoch(args, model, data_loader):
    ...
    total_scores = {metric: compute_metric(eval_meter, metric) for metric in args['metrics']}
    return total_scores

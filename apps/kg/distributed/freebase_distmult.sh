...
--batch_size 1000 --neg_sample_size 200 --hidden_dim 400 --gamma 143 --lr 0.08 --max_step 15000 --log_interval 100 \
--batch_size_eval 1000 --neg_sample_size_test 1000 --test -adv --total_machine 4 --num_test_proc 48 --num_client 35 &
...
do
    ...
    --hidden_dim 400 --gamma 10 --lr 0.1 --total_client 140 --server_id $SERVER_ID_LOW &
    let SERVER_ID_LOW+=1
done
...
--batch_size_eval 1000 --neg_sample_size_test 1000 --test -adv --regularization_coef 1e-9 --total_machine 4 --num_client 35 &
...
class RemainderPartition : public NDArrayPartition {
 public:
  ...
  GeneratePermutation(
    ...
    if (ctx.device_type == kDLCUDA) {
      ATEN_ID_TYPE_SWITCH(in_idx->dtype, IdType, {
        return impl::GeneratePermutationFromRemainder<kDLCUDA, IdType>(
  ...
  IdArray MapToLocal(
    ...
    if (ctx.device_type == kDLCUDA) {
      ATEN_ID_TYPE_SWITCH(in_idx->dtype, IdType, {
        return impl::MapToLocalFromRemainder<kDLCUDA, IdType>(
            NumParts(), in_idx);
      });
    }
#endif
  ...
  IdArray MapToGlobal(
    ...
    if (ctx.device_type == kDLCUDA) {
      ATEN_ID_TYPE_SWITCH(in_idx->dtype, IdType, {
        return impl::MapToGlobalFromRemainder<kDLCUDA, IdType>(
 ...
 public:
    ...
    if (ctx.device_type == kDLCUDA) {
      ...
      ATEN_ID_TYPE_SWITCH(in_idx->dtype, IdType, {
        ATEN_ID_TYPE_SWITCH(range_->dtype, RangeType, {
          return impl::GeneratePermutationFromRange<kDLCUDA, IdType, RangeType>(
  ...
  IdArray MapToLocal(
    ...
    if (ctx.device_type == kDLCUDA) {
      ATEN_ID_TYPE_SWITCH(in_idx->dtype, IdType, {
        ATEN_ID_TYPE_SWITCH(range_->dtype, RangeType, {
          return impl::MapToLocalFromRange<kDLCUDA, IdType, RangeType>(
  ...
  IdArray MapToGlobal(
    ...
    if (ctx.device_type == kDLCUDA) {
      ATEN_ID_TYPE_SWITCH(in_idx->dtype, IdType, {
        ATEN_ID_TYPE_SWITCH(range_->dtype, RangeType, {
          return impl::MapToGlobalFromRange<kDLCUDA, IdType, RangeType>(

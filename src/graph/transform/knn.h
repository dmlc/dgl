 ...
 * query_offsets determine the start index of each segment in \a data_points and
 * \a query_points.
 *
 ...
 * points. \param k the number of nearest points. \param num_iters The maximum
 * number of NN-descent iterations to perform. \param num_candidates The maximum
 * number of candidates to be considered during one iteration. \param delta A
 * value controls the early abort.
 */
template <DGLDeviceType XPU, typename FloatType, typename IdType>
void NNDescent(

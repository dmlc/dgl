...
//
//    List<GraphRef> graphs = args[1];
//    std::vector<ImGraphPtr> ptrs(graphs.size());
//    for (size_t i = 0; i < graphs.size(); ++ i) {
//      ptrs[i] = std::dynamic_pointer_cast<ImmutableGraph>(graphs[i].sptr());
//    }
//
//    List<GraphData> graph_data = args[2];

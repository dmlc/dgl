...
DGL_REGISTER_GLOBAL("graph_index._CAPI_DGLSenderCreate")
.set_body([] (DGLArgs args, DGLRetValue* rv) {
...
DGL_REGISTER_GLOBAL("graph_index._CAPI_SenderSendSubgraph")
.set_body([] (DGLArgs args, DGLRetValue* rv) {
...
DGL_REGISTER_GLOBAL("graph_index._CAPI_DGLReceiverCreate")
.set_body([] (DGLArgs args, DGLRetValue* rv) {
    std::string ip = args[0];
    int port = args[1];

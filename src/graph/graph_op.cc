...
std::vector<GraphPtr> GraphOp::DisjointPartitionByNum(GraphPtr graph, int64_t num) {
  ...
  IdArray sizes = IdArray::Empty({num}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
...
IdArray GraphOp::MapParentIdToSubgraphId(IdArray parent_vids, IdArray query) {
  ...
  IdArray rst = IdArray::Empty({query_len}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
...
IdArray GraphOp::ExpandIds(IdArray ids, IdArray offset) {
  ...
  IdArray rst = IdArray::Empty({len}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
  dgl_id_t *rst_data = static_cast<dgl_id_t*>(rst->data);
...
HaloSubgraph GraphOp::GetSubgraphWithHalo(GraphPtr g, IdArray nodes, int num_hops) {
  ...
  IdArray new_src = IdArray::Empty({num_edges}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
  IdArray new_dst = IdArray::Empty({num_edges}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});

...
EdgeArray Graph::InEdges(dgl_id_t vid) const {
  ...
  IdArray src = IdArray::Empty({len}, DLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
  IdArray dst = IdArray::Empty({len}, DLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
  IdArray eid = IdArray::Empty({len}, DLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});

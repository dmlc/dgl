...
EdgeArray Graph::InEdges(dgl_id_t vid) const {
  ...
  IdArray src = IdArray::Empty({len}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
  IdArray dst = IdArray::Empty({len}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});
  IdArray eid = IdArray::Empty({len}, DGLDataType{kDLInt, 64, 1}, DGLContext{kDLCPU, 0});

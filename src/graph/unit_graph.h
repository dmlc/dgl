...
class UnitGraph : public BaseHeteroGraph {
 public:
   ...
   * CachingHostAllocator, if available. Otherwise, an error will be thrown. If
   * any of the underlying structures (incsr, outcsr, coo) are already pinned,
   * the function will simply use its original copy.
   */

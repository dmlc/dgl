 ...
 * \file graph/sampling/atomic.cuh
 * \brief Atomic functions
 */
#ifndef DGL_GRAPH_SAMPLING_RANDOMWALKS_ATOMIC_CUH_
#define DGL_GRAPH_SAMPLING_RANDOMWALKS_ATOMIC_CUH_
...
#endif // DGL_GRAPH_SAMPLING_RANDOMWALKS_ATOMIC_CUH_

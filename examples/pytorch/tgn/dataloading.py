...
#from dgl.dataloading.pytorch import _pop_subgraph_storage, _pop_storages, EdgeDataLoader
...
class TemporalEdgeDataLoader(DistDataLoader):
    ...
    def __init__(self, g, eids, graph_sampler, device='cpu', collator=TemporalEdgeCollator, **kwargs):
        ...
        self.device = device
        dgl.dataloading.dist_dataloader._remove_kwargs_dist(dataloader_kwargs)
        super().__init__(

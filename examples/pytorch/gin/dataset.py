"""Graph Data Sets Processing
Data sets include:
COLLAB, IMDBBINARY, IMDBMULTI, REDDITBINARY, REDDITMULTI5K, MUTAG, NCI1, PROTEINS, PTC
...
_urls = {
    'MUTAG': 'dataset/MUTAG/MUTAG.txt',
    #OTHER: 'dataset/OTHER/OTHER.txt',
}


class GraphDataset(object):
    """The dataset class.
    The graph datset class processes all data sets listed above.
    ...
    def __init__(self, name, self_loop, degree_as_nlabel=False):
        ...
        self.file = os.path.abspath(os.path.join(os.getcwd(), _urls[name]))

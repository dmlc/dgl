...
def train(args, dataset, g, feats, paper_offset):
    ...
    feats = dgl.contrib.UnifiedTensor(feats, device=torch.device("cuda:0"))
...
if __name__ == '__main__':
    ...
    feats = np.memmap(args.full_feature_path, mode='r', dtype='float16', shape=(num_nodes, num_features)).copy()

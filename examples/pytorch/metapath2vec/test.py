...
if __name__ == "__main__":
    ...
    for line in file:
        ...
        #        author_embed_dict[embed[0]].append(float(embed[j]))
            ...
            #author_embed_dict[embed[0]] = []
            #for i in range(1, len(embed), 1):
                #author_embed_dict[embed[0]].append(float(embed[i]))
    ...
    for time in range(experiment_times):
        ...
        #author_embedding = np.array([])
        #for author in author_embed_dict.keys():
            #temp = np.array(author_embed_dict[author])
            #if len(author_embedding) == 0:
                #author_embedding = temp
            #else:
                #author_embedding = np.vstack((author_embedding, temp))
    ...
    print(macro_average_venue/float(10))
    print(micro_average_venue/float(10))
    #print(macro_average_author / float(10))
    #print(micro_average_author / float(10))

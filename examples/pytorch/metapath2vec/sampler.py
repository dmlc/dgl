...
def construct_id_dict():
    ...
    id_to_author = {}
    id_to_conf = {}
    f_3 = open("/Users/ziqiaom/Desktop/net_dbis/id_author.txt", encoding="ISO-8859-1")
    f_4 = open("/Users/ziqiaom/Desktop/net_dbis/id_conf.txt", encoding="ISO-8859-1")
    f_5 = open("/Users/ziqiaom/Desktop/net_dbis/paper.txt", encoding="ISO-8859-1")
    while True:
        z = f_3.readline()
        if not z:
            break
...
def construct_types_mappings():
    ...
    paper_to_conf = {}
    conf_to_paper = {}
    f_1 = open("/Users/ziqiaom/Desktop/net_dbis/paper_author.txt", "r")
    f_2 = open("/Users/ziqiaom/Desktop/net_dbis/paper_conf.txt", "r")
    for x in f_1:
        x = x.split('\t')
        x[0] = int(x[0])
        x[1] = int(x[1].strip('\n'))
...
def generate_metapath():
    output_path = open("/Users/ziqiaom/Desktop/net_dbis/output_path.txt", "w")

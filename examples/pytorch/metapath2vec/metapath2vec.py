...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str, help="download test files to local path")
    args = parser.parse_args()
    m2v = Metapath2VecTrainer(args)
    m2v.train()
    if args.download == None:
        print("begin testing")
        trivial_test(args.test_path, args.output_file)

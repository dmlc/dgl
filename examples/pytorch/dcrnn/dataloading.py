...
if __name__ == '__main__':
    metr_graph = METR_LAGraphDataset()
    metr_timeseries = METR_LATrainDataset()
    loader = DataLoader(metr_timeseries,batch_size=20,num_workers=7,shuffle=True)
    print(metr_timeseries.mean,metr_timeseries.std)
    for x,y in loader:

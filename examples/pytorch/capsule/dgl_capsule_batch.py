...
class DGLBatchCapsuleLayer(nn.Module):
    ...
    def construct_graph(self):
        ...
        pre_layer_nodes = list(range(self.in_channel))
        this_layer_nodes = list(range(self.in_channel, self.in_channel + self.num_unit))
        u, v = [], []
    ...
    def forward(self, x):
        ...
        this_layer_nodes_feature = self.g.get_n_repr()['h'][self.in_channel:self.in_channel + self.num_unit]

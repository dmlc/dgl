...
class InteractionNet(nn.Module):
    ...
    def forward(self,g,n_feat,e_feat,global_feats,relation_feats):
        with g.local_scope():
            out_n,out_e = self.in_layer(g,n_feat,e_feat,global_feats,relation_feats)
...
class InteractionLayer(nn.Module):
    ...
    mode : str
        ...
        nne : [src_feat,dst_feat,edge_feat]
        n_n : [src_feat-edge_feat]
    '''
    def __init__(self,in_node_feats,
        ...
        input_shape = 2*self.in_node_feats+self.in_edge_feats if mode== 'nne' else self.in_edge_feats+relate_feats

...
One can see
`GraphSAGE <https://github.com/dmlc/dgl/blob/master/graphbolt_examples/node_classification.py>`__
and
`RGCN <https://github.com/dmlc/dgl/blob/master/graphbolt_examples/rgcn/hetero_rgcn.py>`__

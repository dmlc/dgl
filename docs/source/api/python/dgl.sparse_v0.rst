...
.. autoclass:: SparseMatrix
	:members: shape, nnz, dtype, device, row, col, val, __call__, indices, coo, csr, csc, dense, neg, __neg__, inv, softmax
...
.. autoclass:: DiagMatrix
	:members: val, shape, __call__, nnz, dtype, device, as_sparse, neg, __neg__, inv, softmax

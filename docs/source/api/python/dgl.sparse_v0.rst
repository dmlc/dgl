...
.. autoclass:: SparseMatrix
	:members: shape, nnz, dtype, device, row, col, val, __call__, indices, coo, csr, csc, dense, T, transpose
...
.. autoclass:: DiagMatrix
	:members: val, shape, __call__, nnz, dtype, device, as_sparse, T, transpose

...
dgl_linux_libs = 'build/libdgl.so, build/runUnitTests, python/dgl/_ffi/_cy3/core.cpython-36m-x86_64-linux-gnu.so, python/dgl/_ffi/_cy3/core.cpython-37m-x86_64-linux-gnu.so, build/tensoradapter/pytorch/*.so'

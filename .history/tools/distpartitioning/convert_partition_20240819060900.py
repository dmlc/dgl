...
def create_dgl_object(
    ...
    if use_graphbolt:
        ...
        shape=th.IntTensor(max(part_local_src_id)+1,max(part_local_dst_id)+1)
        adj_matrix = dglsp.from_coo(th.tensor(part_local_src_id, dtype=th.int64), th.tensor(part_local_dst_id,dtype=th.int64),shape=(shape,shape))
        print(adj_matrix)
